...
import (
	...
	_ "github.com/fatal-fruit/ns/module"
	...
	nsmodulev1 "github.com/fatal-fruit/ns/api/module/v1"
	"github.com/fatal-fruit/ns/keeper"
	nstypes "github.com/fatal-fruit/ns/types"
)

// ExampleModule is a configurator.ModuleOption that add the ns module to the app config.
var ExampleModule = func() configurator.ModuleOption {
	return func(config *configurator.Config) {
		config.ModuleConfigs[nstypes.ModuleName] = &appv1alpha1.ModuleConfig{
			Name:   nstypes.ModuleName,
			Config: appconfig.WrapAny(&nsmodulev1.Module{}),
		}
	}
}
